// app/site/agenti-horeca-verona/gestione-clienti/page.tsx
// Pagina SEO: Gestione Clienti Verona

export const metadata = {
  title: "AI CoPilot per Personalizzazione Vendite HoReCa a Verona | REPING",
  description: "AI CoPilot per agenti HoReCa a Verona. Note clienti intelligenti, suggerimenti proattivi e personalizzazione vendite. Crittografia End-to-End.",
  keywords: ["ai copilot vendite verona", "personalizzazione vendite horeca", "note clienti intelligenti", "suggerimenti proattivi", "agenti commercio ai"],
};

export default function GestioneClientiVeronaPage() {
  return (
      ...
      <header className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-20">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6">
            AI CoPilot per Personalizzazione Vendite HoReCa a Verona
          </h1>
          
          <p className="text-xl text-slate-300 leading-relaxed">
            Ogni cliente è diverso. <strong className="text-white">Reping AI CoPilot analizza le tue note e suggerisce proattivamente il momento e l'offerta giusti</strong> per ogni ristorante e bar a Verona.
          </p>
        </div>
      </header>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="prose prose-slate max-w-none">
            <p className="text-lg text-slate-700 leading-relaxed mb-4">
              Se sei un <strong>Agente di Commercio HoReCa</strong> a <strong>Verona</strong>, sai che ogni ristorante 
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 hover:border-blue-300 hover:shadow-lg transition">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-700 mb-3">
                    A febbraio, quando pianifichi il giro a Verona, Reping ti avvisa: <strong>"Il ristorante Dante voleva 
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 hover:border-blue-300 hover:shadow-lg transition">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-700 mb-3">
                    Se un cliente HoReCa a Verona non ordina da 45 giorni (sopra la media del suo segmento), Reping ti 
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="prose prose-slate max-w-none mb-8">
            ...
            <p className="text-lg text-slate-700 leading-relaxed mb-4">
              Per un agente HoReCa a Verona con 50 clienti attivi e fatturato medio di €120k/anno, questo si traduce in:
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <ul className="space-y-3">
            <li>
              <a 
                href="/agenti-horeca-verona/pianificazione-percorsi" 
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-slate-300 mb-10 leading-relaxed">
            ...
            HoReCa qualificati</strong> a Verona per testare Reping. Accesso gratuito alla suite <strong className="text-white">BUSINESS 
