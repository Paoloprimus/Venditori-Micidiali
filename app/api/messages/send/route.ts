...
export async function POST(req: Request) {
  ...
  const body = (await req.json().catch(() => null)) as { content?: string; terse?: boolean; conversationId?: string } | null;
