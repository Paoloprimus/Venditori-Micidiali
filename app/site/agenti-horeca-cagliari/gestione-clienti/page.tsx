// app/site/agenti-horeca-cagliari/gestione-clienti/page.tsx
// Pagina SEO: Gestione Clienti Cagliari

export const metadata = {
  title: "AI CoPilot per Personalizzazione Vendite HoReCa a Cagliari | REPING",
  description: "AI CoPilot per agenti HoReCa a Cagliari. Note clienti intelligenti, suggerimenti proattivi e personalizzazione vendite. Crittografia End-to-End.",
  keywords: ["ai copilot vendite cagliari", "personalizzazione vendite horeca", "note clienti intelligenti", "suggerimenti proattivi", "agenti commercio ai"],
};

export default function GestioneClientiCagliariPage() {
  return (
    <div className="font-sans bg-white">
      ...
      <header className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-20">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6">
            AI CoPilot per Personalizzazione Vendite HoReCa a Cagliari
          </h1>
          
          <p className="text-xl text-slate-300 leading-relaxed">
            Ogni cliente è diverso. <strong className="text-white">Reping AI CoPilot analizza le tue note e suggerisce proattivamente il momento e l'offerta giusti</strong> per ogni ristorante e bar a Cagliari.
          </p>
        </div>
      </header>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="prose prose-slate max-w-none">
            <p className="text-lg text-slate-700 leading-relaxed mb-4">
              Se sei un <strong>Agente di Commercio HoReCa</strong> a <strong>Cagliari</strong>, sai che ogni ristorante 
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 hover:border-blue-300 hover:shadow-lg transition">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-700 mb-3">
                    A febbraio, quando pianifichi il giro a Cagliari, Reping ti avvisa: <strong>"Il ristorante Dante voleva 
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 hover:border-blue-300 hover:shadow-lg transition">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-700 mb-3">
                    Se un cliente HoReCa a Cagliari non ordina da 45 giorni (sopra la media del suo segmento), Reping ti 
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-slate-900 mb-6">
            ROI della personalizzazione: numeri reali per agenti HoReCa
          </h2>
          ...
          <div className="prose prose-slate max-w-none mb-8">
            ...
            <p className="text-lg text-slate-700 leading-relaxed mb-4">
              Per un agente HoReCa a Cagliari con 50 clienti attivi e fatturato medio di €120k/anno, questo si traduce in:
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <ul className="space-y-3">
            <li>
              <a 
                href="/agenti-horeca-cagliari/pianificazione-percorsi" 
                className="flex items-center gap-3 text-blue-600 hover:text-blue-800 text-lg hover:underline"
              >
                <span>→</span> Pianificazione Percorsi per Agenti HoReCa a Cagliari
              </a>
            </li>
            <li>
              <a 
                href="/agenti-horeca-roma/gestione-clienti" 
                className="flex items-center gap-3 text-blue-600 hover:text-blue-800 text-lg hover:underline"
              >
                <span>→</span> AI CoPilot Vendite per Agenti HoReCa a Roma
              </a>
            </li>
            <li>
              <a 
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-slate-300 mb-10 leading-relaxed">
            ...
            HoReCa qualificati</strong> a Cagliari per testare Reping. Accesso gratuito alla suite <strong className="text-white">BUSINESS 
